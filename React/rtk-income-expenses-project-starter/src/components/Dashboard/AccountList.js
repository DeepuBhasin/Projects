...
const AccountList = ({ profile }) => {
  ...
  return (
    <React.Fragment>
      {profile?.accounts?.length <= 0 ? (<div style={{ display: 'flex', justifyContent: 'center' }}>
        <Link
          to={"/add-account"}
      ...
      >
        <div className="container px-4 mx-auto">
          ...
          {accounts?.map(item => (
            <div className="flex flex-wrap -mx-4" key={item?.id}>
                ...
                <div className="bg-coolGray-50 group-hover:bg-coolGray-100 rounded-md shadow-md transition duration-200">
                  <div className="flex flex-wrap items-start justify-between p-10 -mx-4">
                    ...
                    <div className="w-full lg:w-1/3 px-4 lg:text-right">
                      ...
                      >
                        <span className="mr-2">View Accounts</span>
                        <svg
                          width={20}
                          height={20}
                          viewBox="0 0 20 20"
