            ...
            <table className="w-full">
              <tbody>
                ...
                {transactions?.map((transaction) => (
                  ...
                  <tr className="h-18 border-b border-coolGray-100" key={transaction?.id}>
                    ...
                    <td className="whitespace-nowrap px-4 bg-white text-sm font-medium text-green-500 text-center">
                      {transaction?.amount}
                    </td>
