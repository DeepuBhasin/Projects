...
const AddAccount = () => {
  ...
  const success = useSelector((state) => state?.accountData?.success);
      ...
      <div className="container px-4 mx-auto">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="mb-12 font-medium text-lg text-gray-600 leading-normal">
            ...
            {success && <h2 className="text-center text-green-600 mt-5 text-lg message">Account Added Successfully</h2>}
          </p>
